"""
Django settings for vtest6234aifunction_9 project.
...
ROOT_URLCONF = 'vtest6234aifunction_9.urls'
...
WSGI_APPLICATION = 'vtest6234aifunction_9.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest6234AIfunction Support <support@vtest6234aifunction-9.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest6234aifunction_9 API",
    "DESCRIPTION": "API documentation for vtest6234aifunction_9 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest6234aifunction_9.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest6234aifunction_9.storage_backends.AzureStaticStorage"
